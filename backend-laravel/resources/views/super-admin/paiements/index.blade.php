...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <nav>
        <span class="text-muted">Maison</span> &gt; <span>Super Admin</span> &gt; <span>Paiement</span>
    </nav>
</div>
...
<div class="content-card p-4 mb-4">
    ...
    <form method="GET" action="{{ route('super-admin.paiements.index') }}">
    ...
    @if($demandes && $demandes->count() > 0)
        @foreach($demandes as $demande)
            ...
            <div class="content-card mb-4 p-4">
                ...
                <div class="text-end">
                    @if(!$demande->est_paye)
                        <form action="{{ route('super-admin.paiements.marquer-paye', $demande->id_demande) }}"
                    ...
                    @else
                        <form action="{{ route('super-admin.paiements.annuler', $demande->id_demande) }}"
                              method="POST" class="d-inline"
