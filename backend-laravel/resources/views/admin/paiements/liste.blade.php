...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <nav>
        ...
        <a href="{{ route('admin.paiements.index') }}" class="text-decoration-none">Paiement</a> &gt;
        <span>Liste</span>
    </nav>
</div>
...
{{-- ═══════════ BOUTON RETOUR ═══════════ --}}
<div class="mb-3">
    <a href="{{ route('admin.paiements.index') }}" class="btn btn-sm btn-outline-secondary">
        ...
        <div class="content-card p-3">
            ...
            <div style="max-height: 600px; overflow-y: auto;">
                @foreach($listeMois as $m)
                    <a href="{{ route('admin.paiements.liste', ['mois' => $m['valeur']]) }}"
